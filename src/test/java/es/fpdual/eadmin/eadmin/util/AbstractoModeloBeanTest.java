...
import es.fpdual.eadmin.eadmin.modelo.ModeloBaseDocumentacionElectronica;

public abstract class AbstractoModeloBeanTest<T extends ModeloBaseDocumentacionElectronica> {
